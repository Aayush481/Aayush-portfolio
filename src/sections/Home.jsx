    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-y-12 lg:gap-x-16 items-center">
        ...
        <div className="flex flex-col justify-center text-center lg:text-left">
          <div className="w-full mx-auto max-w-2xl lg:max-w-[49rem]">
            {/* Typing effect */}
            <motion.div
            ...
            {/* Heading */}
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-blue-400 to-blue-800">
              Hello, I'm <span className="text-white block mt-2">Aayush</span>
            </h1>

            {/* Description */}
            <p className="mt-6 text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl leading-relaxed">
            ...
            <div className="mt-6 flex flex-wrap justify-center lg:justify-start gap-4 mb-8">
              <a href="#projects" className="text-white hover:text-gray-300 bg-gradient-to-r from-pink-500 to-blue-500 px-5 py-3 rounded-full font-medium shadow-lg hover:opacity-90 transition duration-300">
                View Projects
              </a>
              <a href={resume} target="_blank"
                rel="noopener noreferrer"
                className="hidden md:inline-block text-black hover:text-gray-300 bg-white px-5 py-2 rounded-full font-medium shadow-lg hover:opacity-90 transition duration-300">
                My Resume
              </a>
            </div>
            {
        ...
        <div className="flex justify-center items-center">
          <img
            ...
            alt="Profile"
            className="w-full max-w-[250px] sm:max-w-[300px] md:max-w-[350px] lg:max-w-[400px] xl:max-w-[450px] object-cover rounded-full border-4 border-white shadow-lg"
          />
        </div>
      </div>
    </section>
